  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_disabled: "text-slate-500 dark:text-gray-400 opacity-20",
        disabled: "cursor-not-allowed bg-transparent hover:bg-transparent text-slate-500 dark:text-gray-400",
        day_range_middle:
